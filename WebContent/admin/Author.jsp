...
<tr>
	...
	<td> <input type="text" name="authorfname" id="authorfname" required/></td>
</tr>

<tr>
	<td> Author Last Name : </td>
	<td> <input type="text" name="authorlname" id="authorlname" required/></td>
</tr>


<tr align="center">
	<td colspan="2" style="padding-top: 10px;"> <input class="button button-3d button-primary button-rounded" type="submit" value="Add Author" /></td>
</tr>
</table>
